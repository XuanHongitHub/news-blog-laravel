...
<main id="main">
        ...
        <div class="col-md-9">
          ...
          <div class="row">
            ...
            <div class="col-lg-8">
              @if (isset($techPost[3]))
              <div class="post-entry-1">
                <a href="{{ url('/single-post', [$techPost[3]->slug]) }}"><img src="{{ $techPost[3]->preview }}" alt=""
                    class="img-fluid"></a>
                <div class="post-meta"><span
                ...
                <h2 class="mb-2"><a href="{{ url('/single-post', [$techPost[3]->slug]) }}">{{ $techPost[3]->title }}</a>
                </h2>
                {{-- <span class="author mb-3 d-block">Jenny Wilson</span> --}}
  ...
  <section class="category-section">
    <div class="container" data-aos="fade-up">
      ...
      <div class="section-header d-flex justify-content-between align-items-center mb-5">
        <h2>Du Lịch</h2>
        <div><a href="{{ url('single-category', 'du-lich') }}" class="more">Các Bài Viết Du Lịch</a></div>
      </div>
